...
function Quote() {
  ...
  return (
    <div className="quote-container h-full max-w-xl mt-10 flex p-5 ">
      {loading ? (
        <Loading />
      ) : errorMessage ? (
        <p className="text-center text-red-500 font-medium">{errorMessage}</p>
      ) : quote ? (
        <div className="bg-white border-l-4 border-blue-500 shadow-md rounded-lg p-6 transition-all duration-300 hover:shadow-xl max-w-xl mx-auto">
